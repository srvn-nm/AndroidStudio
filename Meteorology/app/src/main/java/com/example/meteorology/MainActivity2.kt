...
import com.example.meteorology.databinding.ActivityMain2Binding
...
class MainActivity2 : AppCompatActivity() {
    ...
    fun showInfo(city: String, weather:String, imageUrl:String, sunrise:String, sunset:String, temp:Double, feelsLike:Double,tempMin:Double,tempMax:Double,pressure:Int,humidity:Int){
        ...
        Glide.with(this@MainActivity2).load(imageUrl).into(binding.weatherIcon)
    ...
    fun reloadData(view:View){
        ...
        binding.pressure.text = "Pressure: --"
        binding.humidity.text = "Humidity: --"
        Glide.with(this@MainActivity2).load(R.drawable.ic_refresh).into(binding.weatherIcon)
        refreshData()
    }
}